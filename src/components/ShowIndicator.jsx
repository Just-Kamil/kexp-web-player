...
function ShowIndicator() {
    ...
    return (
        <div className='flex flex-col justify-between w-30/100 m-2 bg-black/50 rounded-lg backdrop-blur-2xl shadow-lg'>
            <div className='flex flex-col ml-2 mt-2'>
                <h4 className='italic mb-0'>Currently on Air...</h4>
                <h2 className='font-bold text-lg  md:text-lg  lg:text-2xl xl:text-4xl -mt-2'>{show.programName}</h2>
            </div>
